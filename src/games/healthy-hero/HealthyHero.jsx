...
const MASCOT_POS = {
  m1: { w: 760, right: -70, bottom: -90 }, // μέσα στον κίτρινο κύκλο
  m2: { w: 720, right: -70, bottom: -80 }, // μέσα στον κίτρινο κύκλο
  m3: { w: 560, right: -30, bottom: 250 }, // πιο πάνω, να μη σκεπάζει ΧΡΟΝΟΣ/ΣΚΟΡ
}
